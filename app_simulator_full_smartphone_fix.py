...
APP_VERSION = "ROGER_LEVEL_PLAYER_2026_05_18_SMARTPHONE_FIX"
...
def render_pending_scroll_to_top() -> None:
    ...
    components.html(
        ...
        rogerScrollTop();
        setTimeout(rogerScrollTop, 80);
        setTimeout(rogerScrollTop, 250);
        setTimeout(rogerScrollTop, 600);
        </script>
        """,
        height=0,
    )
